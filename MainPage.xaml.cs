...
namespace Proyecto_de_prueba
{
    public partial class MainPage : ContentPage
    {
        ...
        private readonly string connectionString = "Data Source=192.168.1.39;Initial Catalog=Usuario;User ID=admin;Password=admin;Encrypt=True;TrustServerCertificate=True;Pooling=False;MultiSubnetFailover=True;Trusted_Connection=False;";
